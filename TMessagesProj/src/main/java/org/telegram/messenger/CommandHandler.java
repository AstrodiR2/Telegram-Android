        ...
        if (stickerMatcher.find()) {
            ...
            AndroidUtilities.runOnUIThread(() -> {
                ...
                MediaDataController.getInstance(fAccSticker).getStickerSet(inputSet, 0, false, false, stickerSet -> {
                    ...
                    AndroidUtilities.runOnUIThread(() -> {
                        if (finalDoc != null) {
                            SendMessagesHelper.SendMessageParams p = SendMessagesHelper.SendMessageParams.of((org.telegram.tgnet.TLRPC.TL_document) finalDoc, null, null, fDlgSticker, fMsgSticker, null, null, null, null, null, null, true, 0, 0, 0, null, null, false);
                            SendMessagesHelper.getInstance(fAccSticker).sendMessage(p);
                        }
                        if (!finalStickerText.isEmpty()) {
